package com.dataserve.mahfuzatintegration.config.aspect;
...
import com.dataserve.mahfuzatintegration.repository.MobileAuditParamRepository;
import com.dataserve.mahfuzatintegration.repository.MobileAuditRepository;
...
public class Auditing {
    ...
    @AfterReturning(pointcut = "execution(* com.dataserve.mahfuzatintegration.controller..*(..))", returning = "result")
